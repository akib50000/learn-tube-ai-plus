                ...
                <div className="flex-1">
                  ...
                  <Tabs defaultValue="content" className="mb-8">
                    ...
                    <TabsContent value="exercises">
                      <Card className="mb-6">
                        <CardContent className="p-6">
                          ...
                          <p className="mb-6">
                            Reinforce what you've learned with these interactive exercises designed to help you master the concepts covered in this lesson.
                          </p>
                    ...
                    <TabsContent value="challenges">
                      <Card className="mb-6">
                        <CardContent className="p-6">
                          ...
                          <p className="mb-6">
                            Test your skills with these coding challenges. Complete them to earn points and track your progress.
                          </p>
                    ...
                    <TabsContent value="notes">
                      ...
                      <Card>
                        <CardContent className="p-6">
                          <h3 className="text-lg font-medium mb-4">AI Generated Summary</h3>
                          <Button variant="outline" size="sm" className="mb-4">Generate Summary</Button>
                          <div className="p-4 bg-muted/50 rounded-md">
                            <p className="italic text-muted-foreground">
                              Click "Generate Summary" to create an AI-powered summary of this lesson's key points.
                            </p>
                          </div>
                        </CardContent>
                      </Card>
                  ...
                  {/* Progress tracker for this section */}
                  <div className="mt-8 mb-12">
                    <h3 className="text-lg font-medium mb-4">Your Progress in Module 1</h3>
                    <ProgressTracker data={progressData} />
                  </div>
                </div>

                {/* Right Panel - AI Tutor Chat */}
                <div className="md:w-80 lg:w-96 flex-shrink-0 border-l">
                  <div className="h-full flex flex-col">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="bg-muted p-3 rounded-lg">
                            <p className="text-sm">
                              Hello! I'm your AI tutor for this course. I'm here to help explain concepts, answer questions, and provide guidance. What can I help you with today?
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3 flex-row-reverse">
                          ...
                          <div className="bg-primary/10 p-3 rounded-lg">
                            <p className="text-sm">
                              Can you explain the difference between React state and props?
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="bg-muted p-3 rounded-lg">
                            ...
                            <ul className="text-sm mt-2 space-y-1 list-disc pl-4">
                              <li><strong>Props</strong> are passed from parent to child components, like function parameters. They are immutable (read-only).</li>
                              <li><strong>State</strong> is managed within a component and can be changed over time. When state changes, the component re-renders.</li>
                            </ul>
                            <p className="text-sm mt-2">
                              You'll learn more about this in Module 2: React Fundamentals. Would you like me to provide an example?
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="p-4 border-t">
                      ...
                      <div className="mt-2 text-xs text-muted-foreground">
                        Tip: Ask about specific concepts, request examples, or get help with exercises.
                      </div>
                    </div>
                  </div>
                </div>
