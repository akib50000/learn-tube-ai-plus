                    ...
                    <TabsContent value="exercises">
                      <Card className="mb-6">
                        <CardContent className="p-6">
                          ...
                          <p className="mb-6">
                            Reinforce what you've learned with these practical exercises.
                          </p>
                    ...
                    <TabsContent value="challenges">
                      <Card className="mb-6">
                        <CardContent className="p-6">
                          ...
                          <p className="mb-6">
                            Test and improve your skills with these coding challenges.
                          </p>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-2 text-sm">
                          ...
                          <div>
                            ...
                            <p className="font-medium">{formatNumber(course.studentCount)}</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-xs text-muted-foreground">({formatNumber(course.reviewCount)} reviews)</span>
                        </div>
                      ...
                      <CardContent className="p-6">
                        <div className="mb-6 flex items-center justify-between">
                          ...
                          <Badge variant="secondary">
                            {course.rating} / 5 ({reviews.length} reviews)
                          </Badge>
                        </div>
                          ...
                          {questions.map(question => (
                            <div key={question.id} className="border-b pb-6 last:border-0">
                              <div className="flex justify-between mb-3">
                                ...
                                <Badge variant="outline">{question.answers.length} answers</Badge>
                              </div>
                              <p className="text-sm mb-4">{question.content}</p>
                              
                              {/* Answers */}
                              <div className="pl-8 border-l space-y-4">
                                {question.answers.map(answer => (
                                  <div key={answer.id} className={cn("p-3 rounded-md", answer.isAccepted ? "bg-green-50 dark:bg-green-900/20" : "bg-muted")}>
                                    <div className="flex justify-between mb-2">
                                      <div className="flex items-center gap-2">
                                        <Avatar className="h-6 w-6">
                                          ...
                                          <AvatarFallback className="text-xs">{answer.user.name.charAt(0)}</AvatarFallback>
                                        </Avatar>
                                        <div>
